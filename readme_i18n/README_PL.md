...
[sklep play]: https://play.google.com/store/apps/details?id=org.localsend.yidrop_app
...
Aby uruchomić aplikację do zasobnika, użyj flagi `--hidden` (przykład: `yidrop_app.exe --hidden`).
